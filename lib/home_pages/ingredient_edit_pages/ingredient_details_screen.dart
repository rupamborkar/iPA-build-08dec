                ...
                if (_currentTabIndex == 0) {
                  ...
                  if (result == true) {
                    setState(() {
                      ...
                      fetchIngredientDetails(); // Example: Fetch updated ingredients
                    });
                  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow(
                          'Last_update', widget.ingredientData['last_update']),
                      _buildRow(
          ...
          child: Column(
            ...
            children: [
              _buildRow('Qty Purchased:',
                  ...
                  // ingredientData['quantity_purchased']
                  ),
              _buildRow('Weight:',
                  '${ingredientData['weight']} ${ingredientData['weight_unit']}'
                  //ingredientData['weight']
                  ),
