...
import 'package:flutter_app_login/home_screen.dart';
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          print(
              'Response data: $data'); // Log the entire response for debugging

          final token = data['access_token'] ?? ''; // Ensure token is not null
