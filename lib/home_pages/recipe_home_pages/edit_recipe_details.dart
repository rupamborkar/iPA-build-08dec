//working code with navigating through edit tabs(11-11-24)
...
class _RecipeEditDetailsState extends State<RecipeEditDetails> {
  ...
  void _populateControllers(Map<String, dynamic> data) {
    ...
    servingController.text = data['serving_size'] ?? '';
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        buildDropdownField('Category *', recipeCategory),
                        const SizedBox(height: 15),
                        Row(
                          children: [
                            ConstrainedBox(
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 16),
                            Expanded(
                                child: _buildTextField('Tax', taxController)),
                          ],
                        ),
                        const SizedBox(height: 16),
                        Row(
  ...
  //                 // buildDropdownField(
  //                 //     'Category *', ['Dressing', 'Salad', 'Soup', 'Juice']),
  //                 const SizedBox(height: 15),
  //                 Row(
  //                   children: [
  //                     ConstrainedBox(
  ...
  //                         maxWidth: 200, // Set the max width as needed
  //                       ),
  //                       child: _buildTextField('Origin', originController),
  //                     ),
  //                     const SizedBox(width: 16),
  //                     Expanded(
  //                       child: Column(
  ...
  //                           const SizedBox(height: 8),
  //                           ToggleButtons(
  //                             isSelected: [_useAsIngredient, !_useAsIngredient],
  //                             onPressed: (int index) {
  //                               setState(() {
  //                                 _useAsIngredient = index == 0;
  //                               });
  ...
  //                     Expanded(
  //                         child:
  //                             _buildDisabledTextField('Cost', costController)),
  //                     const SizedBox(width: 16),
  //                     Expanded(child: _buildTextField('Tax', taxController)),
  //                   ],
  //                 ),
  //                 const SizedBox(height: 16),
  //                 Row(
  ...
  //                 'Update',
  //                 style: TextStyle(
  //                     fontSize: 18, color: Color.fromRGBO(253, 253, 253, 1)),
  //               ),
  //             ),
  //           ),
  //         ),
    ...
    return RecipeTabs(
      ...
      tabViews: [
        ...
        EditIngredientDetails(
          recipeId: recipeId,
        ), // Content for the 'ingredient' tab
        EditMethod(
          recipeId: recipeId,
